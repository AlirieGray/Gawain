...
#TODO: define color palette variables
define gui.accent_color = u'#7F30FF'
...
define gui.hover_color = u'#7F30FF'
...
define gui.insensitive_color = u'#acacac7f'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = u'#A470FF'
define gui.hover_muted_color = u'#A470FF'
